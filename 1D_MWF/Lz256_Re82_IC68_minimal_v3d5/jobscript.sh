...
#SBATCH --nodes=1                 ## 256^2 = 8 cores, 512^2 = 16 cores
#SBATCH --ntasks-per-node=1
##SBATCH --mem-per-cpu=3000
##SBATCH --time=0:15:00
#SBATCH --time 1:30:00
#SBATCH -J v3d5_Lz256_IC68_minimal  # sensible name for the job
...
ln -s ../Lz256_Re68_IC68_newuq_may_v1d3/snapshots/snapshots_s1.h5 restart.h5
python3 main.py
python3 -m dedalus merge_procs snapshots --cleanup
python3 -m dedalus merge_procs time_series --cleanup
